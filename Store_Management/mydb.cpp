...
void MyDB::init()
{
    ...
    db.setDatabaseName("C:/Users/fekya/OneDrive/Bureau/projia/c++/Store_Management/db.sqlite");

    if(QFile::exists("C:/Users/fekya/OneDrive/Bureau/projia/c++/Store_Management/db.sqlite"))
